...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const systemPrompt = language === 'kz'
      ? `Сен ПДД бойынша көмекшісісің. Сұраққа нақты, толық жауап бер. Егер ақпарат жоқ - "Кешіріңіз, мен бұл сұраққа жауап бере алмаймын" деп айт.\n\nДеректер:\n${context}`
      : `Ты помощник по ПДД. Отвечай точно и полно на вопросы. Если информации нет - скажи "К сожалению, я не могу ответить на этот вопрос".\n\nДанные:\n${context}`;
